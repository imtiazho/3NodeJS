...
const HeroSection = () => {
  return (
    <section className="relative w-full min-h-[500px] flex flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-[#fdf2f8] via-[#ffffff] to-[#eff6ff] overflow-hidden">
      
      {/* Decorative Wave Elements (Left and Right) */}
      <div className="absolute left-0 top-1/2 -translate-y-1/2 opacity-20 hidden md:block">
        <div className="w-64 h-64 border-[1px] border-purple-300 rounded-full scale-150 blur-sm"></div>
      </div>
